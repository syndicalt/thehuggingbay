...
<meta name="description" content="A community index of torrents for openly-licensed AI models, weights, and datasets. Sailors unite. ⛵">
<meta property="og:site_name" content="The Hugging Bay">
<meta property="og:type" content="website">
<meta property="og:title" content="${esc(title)}">
<meta property="og:description" content="A community index of torrents for openly-licensed AI models, weights, and datasets. Sailors unite.">
<meta property="og:image" content="https://thehuggingbay.io/card.jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="https://thehuggingbay.io/card.jpg">
...
<footer>
  <nav>
    <a href="/submit">Upload</a> | <a href="/fleet">Fleet Status</a> | <a href="/mirrors">Mirrors</a> |
    <a href="/catalog">Catalog</a> | <a href="/api">API</a> |
    <a href="/policy">Policy</a> | <a href="/policy#takedown">Takedown</a> | <a href="/about">About</a> |
    <a href="https://buymeacoffee.com/corelumen" rel="noopener">☕ Buy us a coffee</a>
  </nav>
...
export function logoHeader({ small = false } = {}) {
  ...
  <h1>The Hugging Bay</h1></a>`
    : `<a class="logo" href="/"><img class="banner-img" src="/banner.webp"
  alt="The Hugging Bay — search open-source AI models. Decentralized mirrors, open licenses only."></a>
  <h1 class="sr-only">The Hugging Bay</h1>`;
  return `
...
export function torrentTable(rows, { heading = '', sort = 'seeds', baseQuery = '' } = {}) {
  ...
  const body = rows.map((t) => {
    ...
    return `<tr data-name="${esc(t.name.toLowerCase())}" data-cat="${esc(t.category)}" data-seeds="${t.seeds}" data-size="${t.size_bytes}" data-date="${esc(t.uploaded_at)}">
  <td class="type">${catBadge(t.category)}</td>
  <td class="name">
    <a class="tname" href="/torrent/${esc(t.infohash)}">${esc(t.name)}</a> ${verifiedBadge(t.verified)}
    <a class="mag" href="${esc(magnetFor(t))}" title="Magnet link">🧲</a>${t.has_torrent ? `
    <a class="mag" href="/torrent/${esc(t.infohash)}.torrent" title="Download .torrent (works without peers)">⬇</a>` : ''}
