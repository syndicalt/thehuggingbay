...
${logoHeader()}
${searchForm()}
<div class="banner">🏴‍☠️ Decentralized mirrors online. Open licenses only. <a href="/policy">Open-source lives on.</a> 🤗</div>
...
<code>bay-cli</code> torrent tool, seedbox automation, and mirrors.</p>
...
email <a href="mailto:dmca@thehuggingbay.io"><b>dmca@thehuggingbay.io</b></a> or open an issue.
